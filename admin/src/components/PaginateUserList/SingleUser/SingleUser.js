...
function SingleUser(props) {
  ...
  const clicked = () => {
    ...
    if (userType === "merchant")
      setMerchantPhone(props.user && props.user.phone);
  ...
  return (
    <div className="SingleUser" onClick={clicked}>
      ...
      <p>
        <span>Country: </span> {props.user && props.user.location.country}{" "}
      </p>
      <p>
        <span>Joined On: </span>{" "}
        {props.user && new Date(props.user.joinDate).toLocaleDateString()}{" "}
      </p>
