  ...
  return (
    <React.Fragment>
      <div className={`navigation ${slide}-navigation`}>
        ...
        <NavLink className="nav-links" activeClassName="activenav" to="/stats">
          <div className="nav-icon">
            <i class="fas fa-chart-line"></i>
          </div>
          <div className={`nav-link-item ${slide}-nav-link-item `}>Stats</div>
        </NavLink>
        <NavLink className="nav-links" activeClassName="activenav" to="/tax">
          <div className="nav-icon">
        ...
        <NavLink className="nav-links" activeClassName="activenav" to="/payout">
          <div className="nav-icon">
            <i class="fas fa-money-check-alt"></i>
          </div>
          <div className={`nav-link-item ${slide}-nav-link-item `}>Payouts</div>
        </NavLink>
        ...
        <NavLink className="nav-links" activeClassName="activenav" to="/config">
          <div className="nav-icon">
