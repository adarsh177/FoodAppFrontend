...
import { AcceptOrder, GetPendingOrders, RejectOrder } from '../../../../APIs/OrderManager';
...
function PendingOrders(props) {
    ...
    return (
      <ScrollView
        ...
        refreshControl={<RefreshControl refreshing={loading} onRefresh={loadPendingOrders} />}>
        {pendingOrders.map(order => {
              ...
              return(
                <PendingOrderCard
                    ...
                    items={items}
                    onCardPressed={() => props.navigation.navigate('orderDetail', {orderId: order._id})}
        ...
        {(pendingOrders.length === 0 && !loading) && <Text style={style.noItem}>No pending orders at the moment</Text>}
      </ScrollView>
    );
}
